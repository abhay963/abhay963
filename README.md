<div align="center">
  ...
  <a href="https://github.com/abhay963">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=13&pause=1000&color=10B981&center=true&vCenter=true&width=400&height=28&lines=%E2%97%8F+Open+to+Software+Engineering+%2F+AI+Roles" alt="Status" />
  </a>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:100%; border-collapse:collapse; background:#030712; border:1px solid #1E293B; border-radius:12px;">
  <tr>
    <!-- LEFT COLUMN: IDENTIFIER & CALLOUT -->
    <td width="58%" valign="middle" align="left" style="padding:28px;">
      <h1 style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif; font-size:34px; font-weight:800; letter-spacing:-0.5px; color:#FFFFFF; margin:0;">
        ABHAY KUMAR YADAV
      </h1>
      <p style="font-family:'Fira Code',monospace; font-size:14px; color:#38BDF8; font-weight:600; margin-top:6px; margin-bottom:14px;">
        Agentic AI Developer &nbsp;|&nbsp; RAG Engineer &nbsp;|&nbsp; Full-Stack
      </p>
      <p style="font-family:-apple-system,sans-serif; font-size:13.5px; color:#94A3B8; line-height:1.6; margin-bottom:20px;">
        Building intelligent systems that<br />
        <code style="color:#38BDF8; background:#0F172A; padding:3px 8px; border-radius:4px; border:1px solid #1E293B;">reason</code> &rarr; 
        <code style="color:#34D399; background:#064E3B; padding:3px 8px; border-radius:4px; border:1px solid #047857;">retrieve</code> &rarr; 
        <code style="color:#F472B6; background:#831843; padding:3px 8px; border-radius:4px; border:1px solid #BE185D;">act</code>
      </p>
      <!-- Tiny Social Pills -->
      <div>
        <a href="https://github.com/abhay963">
    ...
    <!-- RIGHT COLUMN: 3D DEVELOPER GRAPHIC CARD -->
    <td width="42%" valign="middle" align="center" style="padding:16px;">
      <img src="https://raw.githubusercontent.com/abhay963/abhay963/main/hero-visual.svg" width="100%" alt="3D Visual" onerror="this.onerror=null; this.src='https://github-readme-stats.vercel.app/api?username=abhay963&show_icons=true&theme=dark&bg_color=030712&hide_border=true&title_color=38BDF8&icon_color=818CF8&text_color=94A3B8';" />
    </td>
  </tr>
</table>
  ...
  <table width="100%" style="border-collapse:collapse;">
    <tr>
      <td align="center" style="background:#0B0F19; border:1px solid #1E293B; border-radius:8px; padding:12px;">
        <img src="https://skillicons.dev/icons?i=cpp,py,js,react,nodejs,postgres,mongodb,express,git,github,vercel&perline=11" alt="Tech Stack Icons" />
        <br />
        <p style="font-family:'Fira Code',monospace; font-size:12px; color:#E2E8F0; margin-top:8px; margin-bottom:0;">
          <font color="#38BDF8"><b>C++</b></font> &nbsp;&middot;&nbsp; 
          <font color="#38BDF8"><b>Python</b></font> &nbsp;&middot;&nbsp; 
          <font color="#E2E8F0">JavaScript</font> &nbsp;&middot;&nbsp; 
          <font color="#E2E8F0">React</font> &nbsp;&middot;&nbsp; 
          <font color="#E2E8F0">Node.js</font> &nbsp;&middot;&nbsp; 
          <font color="#818CF8"><b>PostgreSQL</b></font> &nbsp;&middot;&nbsp; 
          <font color="#818CF8"><b>MongoDB</b></font> &nbsp;&middot;&nbsp; 
